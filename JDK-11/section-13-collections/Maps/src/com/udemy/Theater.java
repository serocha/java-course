...
public class Theater {
    ...
    private List<Seat> seats = new ArrayList<>(); // generic --> using Collection (public for demo)

    // an anonymous inner class implementing a Comparator
    static final Comparator<Seat> PRICE_ORDER;

    static {
        PRICE_ORDER = new Comparator<Seat>() {
            @Override // provides a single implementation of the compare method
            public int compare(Seat seat1, Seat seat2) {
                if (seat1.getPrice() < seat2.getPrice()) {
                    ...
                    return 0; // not a true equals (same price -> different seats), showcases issues with sorted maps
                }
            }
        };
    }
